			...
			<table style="text-align: left;" width ="100%">
					<tr>
						...
						$idkat=$_GET['id_kategoria'];
								 ...
								 $query2 =mysql_query("SELECT * FROM `postyogame` WHERE id_temat = $id and id_kategoria = $idkat");// WHERE id_kategoria = $row0[0]
						...
						<form action=""method ="POST">
								...
								<?php
									...
									if(isset($_POST['dodaj']))
									{
										...
										mysql_query("INSERT INTO postyogame(id_temat,napisal,tresc,id_kategoria) VALUES (\"$id\",\"$usernick\",\"$tresc\",\"$idkat\")");
