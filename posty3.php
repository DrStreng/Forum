			...
			<table style="text-align: left;" width ="100%">
					<tr>
						...
						$idkat=$_GET['id_kategoria'];
								 ...
								 $query2 =mysql_query("SELECT * FROM `postyadministracja` WHERE id_temat = $id and id_kategoria = $idkat");// WHERE id_kategoria = $row0[0]
						...
						<form action=""method ="POST">
								...
								<?php
									...
									if(isset($_POST['dodaj']))
									{
										...
										mysql_query("INSERT INTO postyadministracja(id_temat,napisal,tresc,id_kategoria) VALUES (\"$id\",\"$usernick\",\"$tresc\",\"$idkat\")");
